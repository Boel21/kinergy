...
/******/ (() => {
  ...
  (() => {
    ...
    var src = __webpack_require__(138); // CONCATENATED MODULE: external "gsap"
    const external_gsap_namespaceObject = gsap;
    var external_gsap_default = /*#__PURE__*/ __webpack_require__.n(
      external_gsap_namespaceObject
  ...
  */
    ...
    var body_scroll_lock = __webpack_require__(36); // CONCATENATED MODULE: ./src/etc.clientlibs/hankooktire/clientlibs/clientlib-base/js/common.js
    // [TODO] jquery 로드 분리
    ...
    /* harmony default export */ const js_common = common; // CONCATENATED MODULE: ./src/etc.clientlibs/hankooktire/clientlibs/clientlib-global/js/gnb.js
          ...
          el.addEventListener("mouseenter", function () {
            $header.querySelectorAll(".d2__menu").forEach((el) => {
              if (
                ...
                this.parentNode.querySelector("a").getAttribute("href")
              ) {
                el.classList.remove("is-inactive");
      ...
      if (menuD1.length > 0) {
        ...
        menuD1.forEach((el) => {
          ...
          if (menuSub) {
            ...
            el.querySelector(".d1__link").addEventListener(
              "click",
              function (e) {
    ...
    const external_window_namespaceObject = window; // CONCATENATED MODULE: ./src/etc.clientlibs/hankooktire/clientlibs/clientlib-global/js/keyvisuals.js
    /* harmony default export */ function keyvisuals() {
      external_gsap_default().registerPlugin(
        external_window_namespaceObject.ScrollTrigger
      );
      external_window_namespaceObject.ScrollTrigger.scrollerProxy(
      ...
      external_window_namespaceObject.ScrollTrigger.addEventListener(
        "refresh",
